package com.leslist.lessonslist.presentation.info
...
import com.leslist.lessonslist.databinding.FragmentInstructionBinding
...
class InstructionFragment: Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.accordionDescription1.text = "1/1 Перед началом работы необходимо добавить студентов." +
                ...
                "1/6 Вся информация по колличеству проведенных/запланированных уроков будет отображаться в главном меню приложения доступном в левом верхнем углу экрана вкладки календарь. В остальных разделах вместо главного меню будет стрелка перехода в главное меню."
        ...
        binding.accordionDescription4.text = "4/1 Уроки можно добавить по клику на иконку плюс в правом углу экрана." + "\n" +
                ...
                "4/5 Удалить урок можно выделив его долгим нажатием и последующим кликом в правом верхнем углу, вторая иконка справа (появится при выделение), первая выделит(снимет выделение повторным нажатием) все уроки." + "\n" +
                ...
                "4/9 Отдельным ученикам после сохранения урока, на данный урок (при массовом добавление функция не работает) можно добавить скидки на оплату урока, указав сумму скидки либо указав значение в %(не более 100)"  + "\n" +
                "4/9/1 При добавлении скидки в процентах Вам необходимо после значения поставить символ % (не более 100)." + "\n" +
                "4/9/2 Значение скидки вычитается из стоимости урока и результат выставляется в платеж ученику."
