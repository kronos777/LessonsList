                        ...
                        if(formattedLess >= formatted) {
                            ...
                            if(stIds.size > 0) {
                                for (ids in stIds){
                                    ...
                                    viewModelPayment.addPaymentItem(lessonsItem.title, lessonsItem.description, idLessons.toString(), student.id.toString(), studentData, lessonsItem.price.toString())
