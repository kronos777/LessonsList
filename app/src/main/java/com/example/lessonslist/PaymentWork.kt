                        ...
                        if(formattedLess >= formatted) {
                            ...
                            if(stIds.size > 0) {
                                for (ids in stIds){
                                    ...
                                    viewModelPayment.addPaymentItem(lessonsItem.title, lessonsItem.description, idLessons, student.id, studentData, lessonsItem.price.toString())
                                    ...
                                    viewModelStudent.editStudentItem(student.name, student.lastname, newBalanceStudent.toString(), student.notes, student.group)
                                }
                            }
